	...
	return (
		<>
			...
			<div
				...
				<div className="w-[50%] text-base  font-medium">Istirahat I</div>
			...
			<div
				...
				data-aos="fade-up"
				data-aos-duration="800">
				<div className="w-[50%] text-base  font-medium">Istirahat II</div>
			...
			<div
				...
				<div className="w-[50%] text-base font-medium">Muatan Lokal</div>
