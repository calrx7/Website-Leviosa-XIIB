const BorderStruktur = (props) => {
	...
	return (
		<div className="flex flex-col justify-center items-center"> 
			...
			{ImgUrl && <img src={ImgUrl} alt={Nama} className="w-[80px] h-[80px] object-cover mb-2 rounded-full onDragStart={disableDownload} onTouchStart={disableDownload} onTouchStart={disableDownload}" />} 
